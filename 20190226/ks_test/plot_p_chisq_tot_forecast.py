...
n,b,p=ax_hist.hist(dchi2_tot_stack,bins=bins,histtype='bar',color=colors,stacked=True,alpha=alpha,label=labels)
ax_hist.set_yticks([])
ax_hist.set_xlabel(r'$\Delta\chi^2_{\rm tot}$',fontsize=12)
...
fig.savefig('p_vs_chi2_tot_forecast.pdf')

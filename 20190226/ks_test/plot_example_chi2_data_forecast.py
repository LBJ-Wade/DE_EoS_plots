...
ax_rect1.hlines(-1,xmin=0,xmax=2.5,linestyles='dashed',lw=0.75,colors='k')

ax_rect1.fill_between(z,y1=w2[:,0]-w2[:,1],y2=w2[:,0]+w2[:,1],color=colors[0],alpha=0.4,label=r'${\rm \Lambda JDF^{\ast}}$')
ax_rect1.plot(z,w2[:,0],color=colors[0],ls='-',alpha=0.5)
ax_rect1.fill_between(z,y1=w[:,0]-w[:,1],y2=w[:,0]+w[:,1],color=colors[1],alpha=0.25,label=r'$\Lambda$'+r'JD16$^{\ast}$')
ax_rect1.plot(z,w[:,0],color=colors[1],ls='--',alpha=0.5)

ax_rect1.set_xlim(0,2.5)
ax_rect1.set_ylim(-1.75,-0.25)
...
ax_rect1.text(0.1,-1.65,r'$\Delta\chi^2_{\rm data} = $ ' + str(round(dchi2_data[ids[0]],2))+' ',fontsize=12,color=colors[0])
ax_rect1.text(0.95,-1.65,r'$\Delta\chi^2_{\rm data} = $ ' + str(round(dchi2_data_jd16[ids[0]],2)),fontsize=12,color=colors[1])
#---------------------------------------------------------------

w = loadtxt(EoS_dir+'/eos_'+str(ids[1])+'.txt')
w2 = loadtxt(EoS_dir2+'/eos_'+str(ids[1])+'.txt')
ax_rect2.hlines(-1,xmin=0,xmax=2.5,linestyles='dashed',lw=0.75,colors='k')
ax_rect2.fill_between(z,y1=w2[:,0]-w2[:,1],y2=w2[:,0]+w2[:,1],color=colors[0],alpha=0.4,label='Future constraints')
ax_rect2.plot(z,w2[:,0],color=colors[0],ls='-',alpha=0.5)
ax_rect2.fill_between(z,y1=w[:,0]-w[:,1],y2=w[:,0]+w[:,1],color=colors[1],alpha=0.25,label=r'$\Lambda$'+r'JD16$^{\ast}$')
ax_rect2.plot(z,w[:,0],color=colors[1],ls='--',alpha=0.5)

ax_rect2.set_xlim(0,2.5)
ax_rect2.set_ylim(-1.75,-0.25)
...
ax_rect2.text(0.1,-1.65,r'$\Delta\chi^2_{\rm data} = $ ' + str(round(dchi2_data[ids[1]],2))+' ',fontsize=12,color=colors[0])
ax_rect2.text(0.95,-1.65,r'$\Delta\chi^2_{\rm data} = $ ' + str(round(dchi2_data_jd16[ids[1]],2)),fontsize=12,color=colors[1])
#---------------------------------------------------------------

w = loadtxt(EoS_dir+'/eos_'+str(ids[2])+'.txt')
w2 = loadtxt(EoS_dir2+'/eos_'+str(ids[2])+'.txt')
ax_rect3.hlines(-1,xmin=0,xmax=2.5,linestyles='dashed',lw=0.75,colors='k')
ax_rect3.fill_between(z,y1=w2[:,0]-w2[:,1],y2=w2[:,0]+w2[:,1],color=colors[0],alpha=0.4,label='Future constraints')
ax_rect3.plot(z,w2[:,0],color=colors[0],ls='-',alpha=0.5)
ax_rect3.fill_between(z,y1=w[:,0]-w[:,1],y2=w[:,0]+w[:,1],color=colors[1],alpha=0.25,label=r'$\Lambda$'+r'JD16$^{\ast}$')
ax_rect3.plot(z,w[:,0],color=colors[1],ls='--',alpha=0.5)

ax_rect3.set_xlim(0,2.5)
ax_rect3.set_ylim(-1.75,-0.25)
...
ax_rect3.text(0.1,-1.65,r'$\Delta\chi^2_{\rm data} = $ ' + str(round(dchi2_data[ids[2]],2))+' ',fontsize=12,color=colors[0])
ax_rect3.text(0.95,-1.65,r'$\Delta\chi^2_{\rm data} = $ ' + str(round(dchi2_data_jd16[ids[2]],2)),fontsize=12,color=colors[1])
#---------------------------------------------------------------

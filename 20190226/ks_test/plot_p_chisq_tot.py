...
axScatter1.scatter(chi2_tot[79],p_all[79],marker='o',s=100,linewidths=2,color='',edgecolors='b')
...
axScatter2.scatter(dchi2_tot[79],p_all[79],marker='o',s=100,linewidths=2,color='',edgecolors='b')

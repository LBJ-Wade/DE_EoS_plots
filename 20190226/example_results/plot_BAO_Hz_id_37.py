...
Hz_best_fit_wzcdm = loadtxt('/Users/xyh/GitHub/ClassMC-dev/best_fit/wzCDM_id_37_Hz.txt')
...
bao_best_fit_wzcdm = loadtxt('/Users/xyh/GitHub/ClassMC-dev/best_fit/wzCDM_id_37_BAO.txt')
...
bao_dr12 = loadtxt('/Users/xyh/GitHub/ClassMC-dev/mock_samples/GenBAOs/mock_Dr12_BAO_20190226/DR12_'+idx+'.dat')
DA_lya = loadtxt('/Users/xyh/GitHub/ClassMC-dev/mock_samples/GenBAOs/mock_z2.34/LyAlpha_37.dat')
...
Hz_data = loadtxt('/Users/xyh/GitHub/ClassMC-dev/mock_samples/GenHz/mock_Hz_20190226/Hz_37.dat')
Hz_z = Hz_data[:,0]
idx = Hz_z < 2.34
idx0 = Hz_z>=2.34
...
fig.savefig('example_fit_BAO_Hz_id_37.pdf')

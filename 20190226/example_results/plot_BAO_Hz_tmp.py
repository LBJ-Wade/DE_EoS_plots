...
Hz_best_fit_wzcdm = loadtxt('/Users/xyh/GitHub/ClassMC-dev/best_fit/wzCDM_id_'+idx+'_Hz.txt')
...
bao_best_fit_wzcdm = loadtxt('/Users/xyh/GitHub/ClassMC-dev/best_fit/wzCDM_id_'+idx+'_BAO.txt')
...
DA_lya = loadtxt('/Users/xyh/GitHub/ClassMC-dev/mock_samples/GenBAOs/mock_z2.34/LyAlpha_'+idx+'.dat')
...
Hz_data = loadtxt('/Users/xyh/GitHub/ClassMC-dev/mock_samples/GenHz/mock_Hz_20190226/Hz_'+idx+'.dat')
Hz_z = Hz_data[:,0]
idx = Hz_z < 2.34
idx0 = Hz_z>=2.34

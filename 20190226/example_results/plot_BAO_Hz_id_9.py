...
Hz_best_fit_wzcdm = loadtxt('/Users/xyh/GitHub/ClassMC-dev/best_fit/wzCDM_id_9_Hz.txt')
...
bao_best_fit_wzcdm = loadtxt('/Users/xyh/GitHub/ClassMC-dev/best_fit/wzCDM_id_9_BAO.txt')
...
bao_dr12 = loadtxt('/Users/xyh/GitHub/ClassMC-dev/mock_samples/GenBAOs/mock_Dr12_BAO_20190226/DR12_9.dat')
DA_lya = loadtxt('/Users/xyh/GitHub/ClassMC-dev/mock_samples/GenBAOs/mock_z2.34/LyAlpha_9.dat')

MB = -1.9271020E+01
sn_data = read_JLA_mock('/Users/xyh/GitHub/ClassMC-dev/mock_samples/mock_JLA_20190227_full_cov/MOCK_JLA_9.txt')
sn_z = sn_data[:,0]
...
ax.set_ylabel(r'$D_{A}(z)/D_{A,LCDM}^{fid}(z)$',fontsize=13)
...
Hz_data = loadtxt('/Users/xyh/GitHub/ClassMC-dev/mock_samples/GenHz/mock_Hz_20190226/Hz_9.dat')
Hz_z = Hz_data[:,0]
idx = Hz_z < 2.34
idx0 = Hz_z>=2.34
...
ax.set_yticks(yticks)
ax.set_yticklabels(yticks,fontsize=13)
ax.set_ylabel(r'$H(z)/H_{LCDM}^{fid}(z)$',fontsize=13)
ax.legend(loc='upper right',ncol=1,frameon=True,fontsize=12)
ax.tick_params(axis='both',direction='in')
# ax.grid(linestyle='dashed')
...
# fig.savefig('example_fit_BAO_Hz_id_9.pdf')

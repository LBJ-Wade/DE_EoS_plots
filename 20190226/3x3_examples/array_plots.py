...
for i in range(N1):
    for j in range(N2):
        ...
        w_bestfit = loadtxt(EoS_dir+'/EoS_'+str(cnt+dcnt)+'_w_peak_vals.txt')
        # w_bestfit = loadtxt(EoS_dir+'/EoS_'+str(ids[cnt-1])+'_w_peak_vals.txt')
